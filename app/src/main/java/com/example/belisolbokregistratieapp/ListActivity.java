...
public class ListActivity extends AppCompatActivity {
    ...
    public void refresh_list(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_SELECT, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try{
                    ...
                    Toast.makeText(ListActivity.this,jsonObject.getString("message"),Toast.LENGTH_LONG).show();
                    for (int i = 0; i<jsonArray.length(); i++){
                        ...
                        Client item = new Client(
                                ...
                                o.getString("Phone"),
                                o.getString("Address"),
                                o.getString("KantoorCode"),
                                o.getString("Land"),
                                o.getString("Opmerking")
